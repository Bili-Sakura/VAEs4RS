"""
Run CMMD evaluation for UCMerced dataset on all models.

Usage:
    python run_cmmd_ucmerced.py
"""
...
def main():
    """Run CMMD evaluation for UCMerced on all models."""
    ...
    print("="*80)
    print("Running CMMD evaluation for UCMerced dataset on all models")
    print("="*80)
    ...
    # Run evaluation for UCMerced, all models
    results = evaluate_all(
        config,
        dataset_names=["UCMerced"],  # UCMerced dataset
